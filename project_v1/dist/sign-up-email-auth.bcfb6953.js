...
module.bundle.HMR_BUNDLE_ID = "6ce4a2a8bcfb6953";
"use strict";
...
},{}],"kSC5d":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    authButton.addEventListener("click", async function() {
        ...
        // 입력값이 숫자인지 확인
        if (!/^\d+$/.test(authCode)) authNumberResult.textContent = "숫자를 입력해주세요."; // 숫자가 아닐 경우 메시지 변경
        else {
            // 인증 코드 검증 로직
            ...
            try {
                ...
                if (!response.ok) throw new Error("인증에 실패했습니다. 다시 시도해주시기 바랍니다.");
                //인증 번호 맞음
