document.addEventListener("DOMContentLoaded", function() {
    ...
    const navigationLinks = [
        ...
        {
            id: "menu04Container",
            href: "./application-information1.html"
        },
        {
            id: "option02Container",
            href: "./setting-personal-information.html"
        }
    ];
...
fetchApplicationTypeName() // 희망 지망 직렬 선택 처럼 이름이랑 닉네임 자동으로 호출하는 api 필요합니다.
 //from gpt 참고 코드
 // JavaScript 코드
...
//# sourceMappingURL=setting-account.9370c915.js.map
