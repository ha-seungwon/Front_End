...
module.bundle.HMR_BUNDLE_ID = "755c4774966100b7";
"use strict";
...
const color = d3.scaleOrdinal().domain(data).range([
    "#DDE1E6",
    "#878D96"
]);
...
svg.selectAll("path").data(pie(data)).enter().append("path").attr("d", arc).attr("fill", (d)=>color(d.data));
svg.append("text").attr("class", "percentage").attr("text-anchor", "middle").attr("dy", "0.35em").text(percentage + "%");
var months = [
    "1월",
    "2월",
    "3월",
